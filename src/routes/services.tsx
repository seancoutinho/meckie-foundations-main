  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Two services. One standard. Driveway design and installation, and engineered perimeter walls across Harare.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "From consultation to final inspection — a four-step practice for paving and perimeter walls.",
      },
    ],
  }),
...
const STEPS = [
  [
    "01",
    "Consultation",
    "A site visit. We listen first, measure second. No obligation, no template proposal.",
  ],
  [
    "02",
    "Design & Quote",
    "Drawings, material schedule and a fixed quote — issued within 48 hours.",
  ],
  [
    "03",
    "Installation",
    "Set-out, base preparation, bedding, laying, jointing — overseen by a director.",
  ],
  [
    "04",
    "Final Inspection",
    "A walk-through with the client. We sign off only when you do.",
  ],
] as const;
    ...
    <Reveal delay={0}>
      <section className="container-luxe py-24 md:py-32 grid md:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <Link
            to="/contact"
            className="mt-8 inline-flex link-underline text-[11px] tracking-[0.22em] uppercase"
          >
            Discuss a project →
          </Link>
        </div>
...
function ServicesPage() {
  return (
    <PageShell>
      ...
      <ServiceBlock
        img="/assets/service-driveways.jpg"
        eyebrow="Service 01"
        title="Driveways."
          ...
          <div className="container-luxe">
            <div className="grid md:grid-cols-12 gap-12 items-end">
              ...
              <p className="md:col-span-7 text-base leading-relaxed text-muted-foreground max-w-xl">
                From the first conversation to the final walk-through —
                a sequence we have refined over three decades and several
