  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Driveway pavers, cobbles, slabs, hexagonal pavers, coping, blocks, cladding and architectural feature pieces.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "An architectural catalogue of paving, slabs and feature pieces, engineered in Harare.",
      },
    ],
  }),
...
function ProductsPage() {
  ...
  const filtered = useMemo(() => {
    return PRODUCTS.filter((p) => {
      if (active !== "All" && p.category !== active) {
        return false;
      }
